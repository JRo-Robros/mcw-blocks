...
function render_product_accordion(){
	...
	<div class="wp-block-mcw-blocks-accordion-trigger alignfull"><p>Expand To View All Products</p><div class="mcw-accordion-indicator"><a class="btn round"><i class="fa fa-angle-double-down"></i></a></div></div>
...
for($i = 0; $i< $arrlen; $i+=3){
	...
	for($j = 0; $j < 3; $j++){
		...
		elseif( $additionalcontentadded != true ){
			$block.="<div class='wp-block-mcw-blocks-slidebox'>
			<div class='wp-block-mcw-blocks-slidebox-img slidebox'>
			<figure class='wp-block-image'><img src='http://fakeimg.pl/300x300'></figure>
			<div class='text-over'><p>Technical Service and Repair</p></div>
			</div>
			<div class='wp-block-mcw-blocks-slidebox-content'>
			<div class='container'><h3>Technical Service and Repair</h3><p>Lorem ipsum</p><a class='btn more-link theme-col'>more</a></div>
			</div>
			</div>
			";
			$block.="<div class='wp-block-mcw-blocks-slidebox'>
			<div class='wp-block-mcw-blocks-slidebox-img slidebox'>
			<figure class='wp-block-image'><img src='http://fakeimg.pl/300x300'></figure>
			<div class='text-over'><p>Customer Support</p></div>
			</div>
			<div class='wp-block-mcw-blocks-slidebox-content'>
			<div class='container'><h3>Customer Support</h3><p>Lorem ipsum</p><a class='btn more-link theme-col'>more</a></div>
			</div>
			</div>
			";
